...
import static org.sonar.plugins.clojure.language.ClojureLexer.Literals.CLOJURE_KEYWORD;
...
public enum ClojureGrammar implements GrammarRuleKey {
    ...
    public static Grammar create() {
        ...
        b.rule(VALUE).is(b.firstOf(IDENTIFIER,STRING,INTEGER, MAP, VECTOR, LIST, TRUE, FALSE, NIL, CLOJURE_KEYWORD));
