...
public class ClojureFullSourceTest extends ClojureRuleTest {

    private static final Logger LOG = Loggers.get(ClojureFullSourceTest.class);
    ...
    public void sourceIsClojure() throws IOException {
        ...
        String boa = readFile("src/test/resources/java-illegal-char.clj", UTF_8);
